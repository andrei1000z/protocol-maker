  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] px-6">
      <div className="text-center space-y-4 max-w-sm">
        ...
        <h2 className="text-xl font-bold">Setările nu s-au încărcat</h2>
        <p className="text-sm text-muted-foreground">{error.message || 'Datele profilului sunt temporar indisponibile.'}</p>
