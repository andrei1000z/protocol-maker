  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] px-6">
      <div className="text-center space-y-4 max-w-sm">
        ...
        <h2 className="text-xl font-bold">Settings couldn&apos;t load</h2>
        <p className="text-sm text-muted-foreground">{error.message || 'Your profile data is temporarily unavailable.'}</p>
